    ...
    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div className="navbar-nav ms-auto">
        <Link className="nav-link text-white active m-auto" aria-current="page" to="/"><h5>Home</h5></Link>
          ...
          {/* <Link className="nav-link text-white m-auto ml-4" to="/login"><h5>Register Event</h5></Link>: */}
        ...
        {
          !userLoginStatus?<Link className="nav-link text-white m-auto ml-3" to="login/"><h5>Login</h5></Link>:
          <Link className="nav-link text-white m-auto ml-3" onClick={logoutUser} to="login/"><h5>Logout</h5></Link>
        }
